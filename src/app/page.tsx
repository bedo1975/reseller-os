      ...
      <section className="border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              { icon: settings.trustBadge1Icon, title: settings.trustBadge1Title, desc: settings.trustBadge1Desc, url: '/livraison-rapide' },
              { icon: settings.trustBadge2Icon, title: settings.trustBadge2Title, desc: settings.trustBadge2Desc, url: '/paiement-securise' },
              { icon: settings.trustBadge3Icon, title: settings.trustBadge3Title, desc: settings.trustBadge3Desc, url: '/retours-14-jours' },
              { icon: settings.trustBadge4Icon, title: settings.trustBadge4Title, desc: settings.trustBadge4Desc, url: '/contact' },
            ].map((badge, i) => {
