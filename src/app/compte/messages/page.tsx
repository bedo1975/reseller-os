    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-4 space-y-3">
        ...
        <div className="flex justify-end">
          <Button
            onClick={send}
            disabled={sending || !form.subject.trim() || !form.body.trim() || !rgpdAccepted}
      ...
      <Dialog open={rgpdPopupOpen} onOpenChange={setRgpdPopupOpen}>
        <DialogContent className="sm:max-w-lg max-h-[80vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              Informations sur le traitement de vos données dans la messagerie
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-3 text-sm text-gray-600 py-2">
            <p><strong>Messagerie interne :</strong> les messages que vous envoyez via ce formulaire sont visibles par notre équipe pour répondre à vos questions (commandes, retours, SAV).</p>
            <p><strong>Données stockées :</strong> votre prénom, nom et email sont associés à vos messages pour identification. Le contenu de vos messages est conservé 2 ans après votre dernier échange.</p>
            <p><strong>Transfert :</strong> vos messages ne sont jamais transmis à des tiers. Ils restent sur nos serveurs sécurisés.</p>
            <p><strong>Vos droits :</strong> accès, rectification, effacement de vos messages. Contactez-nous par email pour exercer ces droits.</p>
