  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mb-8">
        <Link href="/compte/commandes" className="bg-white border border-gray-200 rounded-lg p-4 hover:border-[#007bff] transition-colors">
        ...
        <Link href="/compte/messages" className="bg-white border border-gray-200 rounded-lg p-4 hover:border-[#007bff] transition-colors">
