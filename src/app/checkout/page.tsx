  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-6">
      ...
      <nav className="flex items-center gap-1 text-sm text-gray-500 mb-6">
        ...
        <Link href="/panier" className="hover:text-[#007bff]">Panier</Link>
        <ChevronRight className="h-3 w-3" />
        ...
        <div className="lg:col-span-1">
          <div className="bg-white border border-gray-200 rounded-lg p-5 sticky top-28">
            ...
            <p className="text-xs text-gray-400 text-center mt-3">
              ...
              <Link href="/cgv" className="text-[#007bff] hover:underline">CGV</Link>
              {' '}·{' '}
              <Link href="/retractation" className="text-[#007bff] hover:underline">Droit de rétractation</Link>
            </p>
