...
const DEFAULT_PRIVACY = `<div class="space-y-6">
  ...
  <p>Le responsable du traitement des données personnelles collectées sur ce site est JUNASHOP.FR, immatriculée sous le numéro SIRET 44963214000041, dont le siège social est situé 10 rue de la mairie, 30250 JUNAS.</p>
  ...
  <p>Vos données sont destinées exclusivement à JUNASHOP.FR et à ses prestataires techniques (hébergeur, processeur de paiement, transporteur). Elles ne sont jamais vendues ni cédées à des tiers à des fins commerciales.</p>
