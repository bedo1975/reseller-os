...
export const config = {
  ...
  matcher: ['/', '/((?!api/auth|api/users/count|api/users/setup|api/cron|api/vinted/scan|api/uploads|api/boutique|api/invoices/by-number|login|setup|scan|boutique|_next/static|_next/image|favicon.ico|logo.svg|robots.txt|sitemap.xml|uploads|manifest.json|sw.js|icon-|reseller-os\.zip).*)'],
}
